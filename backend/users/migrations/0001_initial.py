    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, db_index=True, max_length=150, null=True, unique=True, validators=[users.models.CustomUser.username_validator], verbose_name='username')),
                ('password', models.CharField(max_length=128, validators=[users.models.CustomUser.password_validator], verbose_name='password')),
                ...
                ('is_active', models.BooleanField(default=False, verbose_name='user active status')),
